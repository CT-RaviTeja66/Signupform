...
emailEl.addEventListener("blur",function(event){
    ...
    if(emailResult.includes("@gmail.com") || emailResult.includes("@outlook.com") || emailResult.includes("@carwale.com")|| emailResult.includes("@cartrade.com") || emailResult.includes("@hotmail.com")){
